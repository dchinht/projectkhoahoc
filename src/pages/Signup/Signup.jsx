        ...
        <div className="flex justify-center self-center  z-10">
          <div className="p-12 bg-white mx-auto rounded-2xl w-100 ">
            ...
            <div className="space-y-2">
                ...
                <input className=" w-full text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-green-400" type='text' placeholder="Enter your username" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700 tracking-wide">Email</label>
                <input className=" w-full text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-green-400" type='email' placeholder="Enter your email" />
              </div>
              <div className="space-y-2">
            ...
            <Link to="/login" style={{ color:'brown',paddingRight:'10px' }}> Sign in</Link>
            <span>
                Copyright © 2021-2022
